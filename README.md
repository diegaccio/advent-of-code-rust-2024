...
| [Day 5](./src/bin/05.rs) | `287.9µs` | `471.9µs` |
...
| [Day 12](./src/bin/12.rs) | `2.2ms` | `11.0ms` |
| [Day 13](./src/bin/13.rs) | `122.0µs` | `123.4µs` |
| [Day 15](./src/bin/15.rs) | `507.7µs` | `671.3µs` |
| [Day 16](./src/bin/16.rs) | `2.2ms` | `515.7ms` |
| [Day 17](./src/bin/17.rs) | `4.0µs` | `216.5µs` |
| [Day 18](./src/bin/18.rs) | `343.1µs` | `537.8µs` |
| [Day 19](./src/bin/19.rs) | `7.9ms` | `52.5ms` |
| [Day 20](./src/bin/20.rs) | `760.6µs` | `14.2ms` |
| [Day 22](./src/bin/22.rs) | `8.5ms` | `16.4ms` |
| [Day 23](./src/bin/23.rs) | `6.0ms` | `24.5ms` |
